...
function render_error($msg) {
  ...
  echo '<title>News ERSU Palermo</title>';
  ...
  echo '<p><a href="https://www.ersupalermo.it" target="_blank" rel="noopener">Apri fonte ufficiale</a></p></div></body></html>';
  exit;
}
...
echo '</ul>';
echo '<div class="meta">Fonte: <a href="https://www.ersupalermo.it" target="_blank" rel="noopener">ERSU Palermo</a></div>';
